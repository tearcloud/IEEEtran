...
define (IoT) as follows:  The Internet of Things (IoT) is a network of heterogeneous devices with sensing and actuating capabilities communicating over the internet.
...
IoT has applications in home automation, smart health, vehicle to vehicle communication, machine to machine comminication to name just a few
...
Provenance has been utilized in application domains such as computer security for access control and intrusion detection, in scientific experiments for reproducability  and in version control systems to mention but a few. 
